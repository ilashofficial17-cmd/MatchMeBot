...
TEXTS = {
    "ru": {
        ...
        "media_already_owned": "😏 У тебя уже есть это — держи!",
        "media_no_video": "У меня пока нет видео 😅 Но есть фотки!",
        "media_no_hot": "У меня пока нет горячего контента 😅",
        "media_no_photo": "У меня пока нет фоток 😅",
        "media_all_seen": "Ты уже видел(а) всё что у меня есть 😏",
        # Gifts
    ...
    "en": {
        ...
        "media_already_owned": "😏 You already have this — here you go!",
        "media_no_video": "I don't have videos yet 😅 But I have photos!",
        "media_no_hot": "I don't have hot content yet 😅",
        "media_no_photo": "I don't have photos yet 😅",
        "media_all_seen": "You've already seen everything I have 😏",
        # Gifts
    ...
    "es": {
        ...
        "media_already_owned": "😏 Ya tienes esto — ¡toma!",
        "media_no_video": "Aún no tengo videos 😅 ¡Pero tengo fotos!",
        "media_no_hot": "Aún no tengo contenido picante 😅",
        "media_no_photo": "Aún no tengo fotos 😅",
        "media_all_seen": "Ya has visto todo lo que tengo 😏",
        # Gifts
